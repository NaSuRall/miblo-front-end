...
export default function BankAccountItem({ account, index }) {
    ...
    return (
        <div className="flex flex-row w-full justify-between p-2 rounded-lg">
            <div
                className="flex flex-row w-full p-5 rounded-xl gap-2 justify-between"
            ...
            >
                <div className="flex flex-col">
                    ...
                    >
                        <Landmark size={15} />
                        Compte n° {account.is_primary ? "1" : index + 2}
                    </h3>
                    <p
                        className="text-sm flex flex-row items-center gap-2"
                        style={{ color: "var(--color-gray)" }}
                ...
                <div className="flex flex-row items-center gap-5">
                    <p
                        className="text-sm py-2 px-5 rounded-xl border"
                        style={{
                        ...
                        <div className="fixed flex justify-end">
                            <div className="absolute top-0 -right-85 bg-white border rounded-lg shadow-lg z-10">
                                <ul className="flex flex-col p-4 relative">
                                    <button
                                        className="flex justify-end absolute right-4 top-2 cursor-pointer text-red-500"
                                    ...
                                    <li
                                        ...
                                        style={{
                                            ...
                                            backgroundColor: "var(--color-bg-red-bytton)",
                                            borderColor: "var(--color-border-red-button)",
                                        }}
                                        onClick={() => {
                                            if (
                                                window.confirm(
                                                    "Es-tu sûr de vouloir clôturer ce compte ?"
                                                )
                                            ) {
